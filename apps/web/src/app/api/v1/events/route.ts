import { listEvents } from "@/lib/data/public-records";
...
export async function GET(request: Request) {
  ...
  const data = await listEvents(limit, { company: params.get("company") ?? undefined, city: params.get("city") ?? undefined, type: params.get("type") ?? undefined, dateFrom: params.get("dateFrom") ?? undefined, offset });
